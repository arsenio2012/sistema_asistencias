<?php
  ...
  $datos_del_usuario = $obj->ver_asistencia($id_usuarios);
  
?>
<div class="ui tiny modal eliminar_usuario_asistencia_modal">
  <div class="header">
    <?php if ($usuarios_seleccionados > 1): ?>
      ¿Desea eliminar las siguientes asistencia?
    <?php else: ?>
      ¿Desea eliminar la siguiente asistencia?
    <?php endif ?>
  </div>
